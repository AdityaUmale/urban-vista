      ...
      <div className="min-h-screen bg-gray-100">
        <div className="container mx-auto p-4">
          <div className="flex items-center justify-center space-x-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-black">Mess Listings</h1>
          </div>
          <div className="flex justify-center items-center min-h-[50vh]">
            <p className="text-gray-600">Loading mess listings...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gray-100">
        <div className="container mx-auto p-4">
          ...
          <div className="flex flex-col items-center justify-center min-h-[50vh]">
            <p className="text-red-500 mb-4">Error loading messes: {error}</p>
            <button 
              onClick={fetchMesses} 
    ...
    <div className="min-h-screen bg-gray-100 relative overflow-hidden">
      ...
      <div className="container mx-auto p-4 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-black mb-4">Mess Listings</h1>
          <p className="text-gray-600 max-w-2xl mx-auto">
            Find local mess and tiffin services. Search, filter, and explore dining options in your area.
          </p>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-8">
          ...
          <div className="w-full md:w-auto flex items-center gap-2 text-sm text-gray-600">
            ...
            <span>{messes.length} mess listings available</span>
          </div>
        </div>
        ...
        {filteredMesses.length === 0 ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredMesses.map((mess) => (
              <div key={mess._id} className="transform transition-all duration-300 hover:scale-105">
                <MessCard mess={mess} />
              </div>
            ))}
          </div>
